...
Reintroduces the labels for the ubi8 image only. https://github.com/elastic/logstash/pull/12500[#12500]
...
When users attempted to delete and recreate a pipeline with the same identifier and configuration, Logstash was unable to pick up the new pipeline. https://github.com/elastic/logstash/issues/12387[#12387]
